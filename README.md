...
⚠️ Este é um _starter kit_ — contém a estrutura, código base e exemplos. Ajuste segredos e variáveis no `.env` antes de rodar.
...
Se trata de um projeto de CRM que deixa mais facil a estrturação dos projetos, e organização de deploys e controle de documentos;
